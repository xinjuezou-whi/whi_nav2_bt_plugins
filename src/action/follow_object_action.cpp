...
#include "whi_nav2_bt_plugins/action/follow_object_action.hpp"
...
namespace whi_nav2_bt_plugins
{
	...
	void FollowObjectAction::on_tick()
	{
		...
		getInput("continuous", goal_.continuous);
...
BT_REGISTER_NODES(factory)
{
	...
	{
		return std::make_unique<whi_nav2_bt_plugins::FollowObjectAction>(
			name, "follow_object_ext", config);
	};

	factory.registerBuilder<whi_nav2_bt_plugins::FollowObjectAction>(
		"FollowObjectExt", builder);
}
