...
#include <whi_interfaces/action/follow_object.hpp>

namespace whi_nav2_bt_plugins
{
	/**
	 * @brief nav2_behavior_tree::BtActionNode class that wraps whi_interfaces/FollowObject
	 */
	class FollowObjectAction
		: public nav2_behavior_tree::BtActionNode<whi_interfaces::action::FollowObject>
	{
		using Action = whi_interfaces::action::FollowObject;
			...
			return providedBasicPorts(
				{
					...
					BT::InputPort<bool>(
						"continuous", true, "Following continously changing target or fixed one"),
