...
{
public:
	static geometry_msgs::msg::PoseStamped toMsg(const float X, const float Y)
	{
...
public:
		...
		float minimum_radius)
	{
		...
		// make a bit tolerance
		if (fabs(tangent_length - start_edge_length_) < 0.05 && fabs(tangent_length - end_edge_length_) < 0.05)
		{
